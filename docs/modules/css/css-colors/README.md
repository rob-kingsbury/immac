...
- [Video: CSS Color Property Values, by Steve Griffith](https://www.youtube.com/watch?v=LYDQ_L7ovyg). A practical run through the notations covered in this module.
