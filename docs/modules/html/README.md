...
The markup that gives a page its structure and meaning. Read top to bottom for a full pass, or open any single module on its own.
...
- [Document Head Best Practices](/modules/html/html-document-structure/head-best-practices.md). A complete head: description, canonical URL, favicon, and the rest.
...
- [Comments That Outlive the Code They Describe](/modules/html/html-comments/comment-longevity.md). Writing a comment that is still true after the code beside it changes.
...
- [Responsive Media Containers](/modules/html/html-iframes/responsive-containers.md). Holding an embed's shape while letting its size flex.
...
- [Elements This Course Names But Doesn't Build With](/modules/html/html-details/elements-not-built-with.md). dialog, template, and popover: what each one does, and why each needs JavaScript to be useful.
